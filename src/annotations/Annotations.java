...
public class Annotations {
    ...
    public @interface SyncField {
        /**
         * If true, the field will be linearly interpolated. If false, it will be
         * interpolated as an angle.
         */
        boolean value();
    ...
    /**
     * Indicates that a field will not be read from the server when syncing the
     * local player state.
     */
    @Target({ ElementType.FIELD })
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Indicates that a field should not be synced to clients (but may still be
     * non-transient)
     */
    @Target({ ElementType.FIELD })
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Indicates that a component field is imported from other components. This
     * means it doesn't actually exist.
     */
    @Target({ ElementType.FIELD })
    @Retention(RetentionPolicy.SOURCE)
    ...
    public @interface Component {
         ...
         * An entity cannot have two base classes, so only one component can have base
         * be true.
         */
    ...
    /**
     * Indicates priority of a method in an entity. Methods with higher priority are
     * done last.
     */
    @Target(ElementType.METHOD)
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Creates a group that only examines entities that have all the components
     * listed.
     */
    @Retention(RetentionPolicy.SOURCE)
    ...
    public @interface Load {
        ...
        /**
         * Fallback string used to replace "@" (the block name) if the region isn't
         * found.
         */
    ...
    /**
     * Annotation that allows overriding CallSuper annotation. To be used on method
     * that overrides method with CallSuper annotation from parent class.
     */
    @Target(ElementType.METHOD)
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Marks a class as a special value type struct. Class name must end in
     * 'Struct'.
     */
    @Target(ElementType.TYPE)
    @Retention(RetentionPolicy.SOURCE)
    ...
    public @interface StructField {
        /**
         * Size of a struct field in bits. Not valid on booleans or floating point
         * numbers.
         */
        int value();
    }
    ...
    public @interface Remote {
        /**
         * Specifies the locations from which this method can cause remote invocations
         * (This -> Remote) [Default: Server -> Client].
         */
        Loc targets() default Loc.server;

        /**
         * Specifies which methods are generated. Only affects server-to-client methods
         * (Server -> Client(s)) [Default: Server -> Client & Server -> All Clients].
         */
        Variant variants() default Variant.all;

        /**
         * The locations where this method is called locally, when invoked locally (This
         * -> This) [Default: No local invocations].
         */
        Loc called() default Loc.none;

        /**
         * Whether the server should forward this packet to all other clients upon
         * receival from a client (Client -> Server -> Other Clients). [Default: Don't
         * Forward Client Invocations]
         */
